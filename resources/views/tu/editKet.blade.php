...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            @endif
            <div class="card">
                <form method="POST" action="{{ route('tu.desc.updateKeterangan', ['id_murid' => $id_murid, 'id_kelas' => $id_kelas]) }}" class="needs-validation" novalidate="">
                    @csrf
                    @method('PUT')
...
<script>
    $(document).ready(function() {
        $('#tgl').on('change', function() {
            ...
            $.ajax({
                url: '{{ route("tu.desc.getKeterangan") }}',
                data: {
                    id_kelas: '{{ $id_kelas }}',
                    id_murid: '{{ $id_murid }}',
                    date: date
