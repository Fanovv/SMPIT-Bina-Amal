...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <form method="POST" action="{{ route('classes.AddClasses') }}" class="needs-validation" novalidate="">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="wali_1" name="wali_1" placeholder="Nama Wali" required>
                                @error('wali_1')
                                <div class="invalid-feedback">
