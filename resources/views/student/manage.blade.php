                        ...
                        <table class="table-striped table" id="table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @endif
                                    <td><a href="/{{ $data->id }}/edit" class="btn btn-icon icon-left btn-warning"><i
                                        ...
                                        <!-- <a href="/admin/manage/delete/{{ $data -> id }}"
                                            class="btn btn-icon icon-left btn-danger" onclick="return confirm('Apakah Anda Benar Ingin Menghapus Data')"><i
                                                class="far fa-edit"></i>Edit</a> -->
                                        <form action="/manage/delete/{{ $data -> id }}" method="POST" class="d-inline">
                                            @csrf
