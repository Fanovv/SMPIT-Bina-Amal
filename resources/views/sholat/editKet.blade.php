...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            @endif
            <div class="card">
                <form method="POST" action="{{ route('desc.updateKeterangan', ['id_kelas' => $id_kelas, 'id_murid' => $id_murid]) }}" class="needs-validation" novalidate="">
                    @csrf
                    @method('PUT')
